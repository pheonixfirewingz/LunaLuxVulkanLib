...
int main()
{
    ...
    VkShaderModule vertShaderModule = vkGenShaderModule(readFile("vert_shader_one.spv"));
    VkShaderModule fragShaderModule = vkGenShaderModule(readFile("frag_shader_one.spv"));
